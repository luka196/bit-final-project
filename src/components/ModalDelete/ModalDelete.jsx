...
export const ModalDelete = ({ id }) => {
  ...
  function deleteReport(id) {
    fetch(`http://localhost:3333/664/api/reports/${id}`, {
      ...
      .then((res) => res.json())
      .then((result) => {
        console.log("Success:", result, `http://localhost:3333/664/api/reports/${id}`, token);
  ...
  return (
    <button onClick={openModal}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
